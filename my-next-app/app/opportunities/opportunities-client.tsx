...
export function OpportunitiesClient({
  ...
  useEffect(() => {
    ...
    setSelectedRegion(f.selectedRegion)
    setSelectedFunding(f.selectedFunding)
  ...
  const filteredOpportunities = opportunities.filter((opp) => {
    if (featuredOnly && !opp.isFeatured) return false
    const matchesSearch =
    ...
    const matchesRegion =
      selectedRegion === "All Regions" || opp.region === selectedRegion
    const matchesFunding =
      selectedFunding === "All Funding" || opp.fundingType === selectedFunding
          ...
          <div className="bg-card rounded-2xl border border-border p-4 md:p-6 mb-8">
            <div className="flex flex-col lg:flex-row gap-4">
              ...
              <div className="flex flex-wrap gap-3">
                <Select
                  value={selectedType}
                  onValueChange={(v) => pushFilters({ selectedType: v })}
                >
                ...
                <Select
                  ...
                  onValueChange={(v) => pushFilters({ selectedRegion: v })}
                >
                  <SelectTrigger className="w-full sm:w-40 h-12">
                ...
                <Select
                  ...
                  onValueChange={(v) => pushFilters({ selectedFunding: v })}
                >
