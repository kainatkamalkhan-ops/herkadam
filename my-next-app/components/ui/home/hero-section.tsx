    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 py-16 md:py-24 lg:py-28">
        <div className="max-w-4xl mx-auto text-center">
          <div className="relative flex w-full flex-col items-center mb-8 md:mb-10">
          ...
          <p className="relative z-10 text-lg md:text-xl text-primary-foreground/85 mb-10 max-w-2xl mx-auto leading-relaxed text-pretty">
